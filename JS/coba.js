...
document.addEventListener('DOMContentLoaded', function() {
    var blacklist = ['cdn4.videas.fr', 'archive.org', 'example.com'];
    var config = {
        url: 'https://lewat.inputekno.com',
        page: 'p/artikel.html',
        keyit: 'AnasRAR',
        countdown: true
    };

    // Fungsi untuk memproses semua link
    ...
    // Deteksi perubahan DOM (misalnya link yang dimasukkan oleh JS)
    const observer = new MutationObserver(function(mutations) {
        mutations.forEach(function(mutation) {
            // Jika ada elemen baru atau atribut href berubah, proses ulang link
    ...
    // Mulai mengamati body untuk perubahan elemen
